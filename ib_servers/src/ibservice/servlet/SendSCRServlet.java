...
public class SendSCRServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			String sql="select * from scr where 1=1 ";
			...
			if(request.getParameter("scr_owner")!=null&&request.getParameter("scr_owner").length()>0){
				sql+="and scr_owner like '%"+request.getParameter("scr_owner")+"%'";
			}
